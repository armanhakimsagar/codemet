                            ...
                            <ul class="about-four__client-img-list list-unstyled">
                                <li>
                                    <div class="about-four__client-img">
                                        <img src="{{ asset('assets/images/resources/about-four-client-img-1-1.jpg') }}"
                                            alt="">
                                    </div>
                                </li>
                                <li>
                                    <div class="about-four__client-img">
                                        <img src="{{ asset('assets/images/resources/about-four-client-img-1-2.jpg') }}"
                                            alt="">
                                    </div>
                                </li>
                                <li>
                                    <div class="about-four__client-img">
                                        <img src="{{ asset('assets/images/resources/about-four-client-img-1-3.jpg') }}"
                                            alt="">
                                    </div>
                                </li>
                                <li>
                            ...
                            <ul class="about-four__points-list about-four__points-list-2 list-unstyled">
                                ...
                                <li>
                                    <div class="about-four__points-list-img">
                                        <img src="{{ asset('assets/images/resources/about-four-points-list-img.jpg') }}"
                                            alt="">
                                    </div>
